  ...
  return (
    <>
      <section>
        <div
          className={
            "text-[#D2D4D7] py-24 xl:py-40 flex flex-col items-center justify-center relative"
          }
        >
          <h1
            className={
              "font-anek font-[900] text-center text-[50px] md:text-[75px] xl:text-[85px] leading-[0.8]"
            }
          >
            START WINNING
            <br />
          ...
          <button
            className={
              "bg-secondary font-[700] text-black py-3.5 px-7 rounded-lg mx-auto w-fit text-center my-3"
            }
          >
            Join the community
          </button>
        ...
        <div
          className={
            "bg-[#232D39]  w-10/12 2xl:w-9/12 mx-auto rounded-2xl py-16 xl:py-24 relative"
          }
        >
          <div
            className={
              "w-11/12 xl:w-10/12 2xl:w-9/12 mx-auto flex flex-col gap-y-4 xl:gap-y-8"
            }
          >
            <div
              className={
                " mx-auto flex lg:flex-row flex-col gap-y-4 sm:gap-x-4"
              }
            >
              <div
                className={
              ...
              >
                <Image
                  src={"/assets/svg/section-seven/check.svg"}
                ...
                <div className={"flex flex-col gap-y-2"}>
                  <button
                    className={
                      " font-[600] shadow-custom-shadow bg-[#2F3843] text-sm py-1.5 px-2.5 w-fit rounded"
                    }
                  >
                    Register
                  </button>
                  <p
                    className={"font-[700] text-[#D2D4D7] text-2xl sm:text-lg"}
                  >
                    Join the Squads
                    <br /> Community
                  </p>
              ...
              >
                <Image
                  src={"/assets/svg/section-seven/fundaccount.svg"}
                  alt={"fundaccount "}
                ...
                />
                <Image
                  src={"/assets/svg/section-seven/fundaccount_mobile.svg"}
                ...
                <div className={"flex flex-col gap-y-2"}>
                  <button
                    className={
                      "w-fit font-[600] text-sm shadow-custom-shadow bg-[#2F3843] py-1.5 px-2.5 rounded"
                    }
                  >
                    Fund Wallet
                  </button>
                  <p className={"font-[700]"}>Fund Your Account</p>
            ...
            >
              ...
              >
                ...
                <div
                  className={
                    "flex flex-col justify-center gap-y-2 px-10 flex-1"
                  }
                >
                  <button
                    className={
                  ...
                  <p className={"font-[700]"}>Create your entry</p>
                  <p className={"text-sm font-[500] w-11/12"}>
              ...
              >
                ...
                <Image
                  src={"/assets/svg/section-seven/cashout.svg"}
                  alt={"card"}
                  className={"!relative"}
                  fill
                />
