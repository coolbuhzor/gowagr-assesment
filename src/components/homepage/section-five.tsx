...
export const SectionFive = () => {
  const twitterPosts: TwitterFeed[] = [
    ...
    },
    {
      ...
      username: "Jujuboi___",
      message:
        "Vandijk & Gravenberch just 4 pass each make make i collect my daily 2k from #Squadgame",
      userImage: "/assets/png/xusers/izu.png",
    ...
    },
    {
      ...
      username: "Jujuboi___",
      message:
        "3 Ws in a row for my picks jhor,🔥 Weekend go soft again 😎 #Squadgame",
      userImage: "/assets/png/xusers/izu.png",
    ...
    },
    {
      ...
      username: "Jujuboi___",
      message:
        "@SquadsDFS is real gee is here 🥰🥰🥰🥰🥰🥰🔥🔥🔥🔥🔥🔥🔥🔥🔥 #Squadgame",
      userImage: "/assets/png/xusers/izu.png",
      imagePost: null,
      hashtag: ["Squadgame"],
      textOverlay: true,
    ...
    <>
      <section className={"pb-0 py-16 xl:py-0"}>
        <div className={"w-fit mx-auto relative"}>
          <h1
            className={
              "text-[30px] md:text-[45px] font-[900] text-white font-anek text-center uppercase m-0 p-0"
            }
          >
            Words on the street
          </h1>
        ...
        <div
          className={
            "flex flex-col justify-center gap-y-7 xl:gap-y-10 pb-0 py-10 xl:py-20"
          }
        >
