    ...
    <>
      <section className={"relative"}>
          ...
          <div className={"flex flex-col gap-y-14"}>
            <div className={"flex flex-col gap-y-4"}>
              <div className={"flex gap-x-5 w-fit justify-center mx-auto"}>
                ...
                <IconBox
                  type={"circle"}
                  image={"/assets/svg/gloves.svg"}
                  color={"bg-[#6DE0E7]"}
                />
                <IconBox
                  type={"square"}
                  image={"/assets/svg/boot.svg"}
                  color={"bg-[#88C80C]"}
                />
                <IconBox
                  type={"circle"}
                  image={"/assets/svg/target.svg"}
                  color={"bg-[#F9CC00]"}
                />
              </div>
              <h1
                className={
                  "font-[900] font-anek text-[50px] xl:text-[70px] 2xl:text-[80px] text-center text-primary leading-[2.5rem] xl:leading-[4rem] tracking-tighter"
                }
              >
                WIN UPTO 100X
                <br />
        ...
        <Image
          ...
          alt={"image "}
          className={
            "absolute h-24 sm:h-20 lg:h-24 xl:h-24 2xl:h-auto right-[14%] md:right-[14%] lg:right-[11%] xl:right-[18%] 2xl:right-[15%] -top-5  xl:-top-10 md:-top-10 lg:-top-10 z-50 pt-5"
          }
          width={100}
          height={100}
        />
